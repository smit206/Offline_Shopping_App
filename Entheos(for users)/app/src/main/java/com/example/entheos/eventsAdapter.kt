...
class eventsAdapter(private val eventList:MutableList<Eventdata>):RecyclerView.Adapter<eventsAdapter.EventViewHolder>() {
    ...
    override fun onBindViewHolder(holder: EventViewHolder, position: Int) {
        ...
        holder.event_title.setText(AddEventModel.name)
        holder.event_date.setText(AddEventModel.date)
        holder.event_time.setText(AddEventModel.time)
        holder.event_text.setText(AddEventModel.discn)
    }
}